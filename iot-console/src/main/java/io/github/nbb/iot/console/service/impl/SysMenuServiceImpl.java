...
import io.github.nbb.iot.console.core.domain.vo.MetaVo;
...
//        String routerName = StrUtil.capitalize(menu.getPath());
    ...
    public boolean isInnerLink(SysMenu menu) {
        return menu.getIsFrame().equals(UserConstants.NO_FRAME) && StrUtil.startWithAny(menu.getPath(), "http://", "https://");
    }
